...
namespace m4k {
public class DetectRadiusAngleGameObject : DetectRadiusAngle<GameObject> {
        public DetectRadiusAngleGameObject(GameObject self, IList<GameObject> others, float maxSquaredRange, float viewAngles = 0, Predicate<GameObject> query = null) : base(self, others, maxSquaredRange, viewAngles, query)
        {
        }

        protected override bool IsValid(GameObject other) {
